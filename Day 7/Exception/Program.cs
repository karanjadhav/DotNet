...
namespace ExceptionAs
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                Employee e1 = new Manager("Udit", 4, "project manager", 89);
                Employee e2 = new GeneralManager("Arjit", 5, "CEO", "Rumi", 50000);
                Employee e3 = new CEO("Papa", 6, 1100000);
